...
<?php 
$_REQUEST["pagename"] = "aboutus";
?>
<body class="homepage trans-header sticky white-datepicker">
<?php include ('topbar.php'); ?>
<div class="internal-page-title about-page" data-parallax="scroll" data-image-src="">
    <h1>About <span>Priya Homes</span></h1>
    <ol class="breadcrumb"><!-- Internal Page Breadcrumb -->
        <li><a href="index.php">Home</a></li>
        <li class="active">About Priya Homes Koothattukulam</li>
    </ol>
</div>
        ...
        <div style=" text-align:left; color:#000; font-weight:400; font-size:16px;">
            ...
            <div class="desc">
                <div class="col-md-6 text-left" style="color:#11100f;">
                    <h4><i class="fa fa-map-marker"></i>&nbsp;&nbsp;Sreedhareeyam Hospital</h4>                    
                </div>
            </div>
        </div>
    </div>
